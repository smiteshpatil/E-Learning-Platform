...
public class SecurityConfig { 
	...
	public SecurityFilterChain authorizeRequests(HttpSecurity http) throws Exception {
		...
		.antMatchers("/products/purchase").hasRole("STUDENT")// only customer can purchase the products
		.antMatchers("/products/add").hasRole("INSTRUCTOR") // only admin can add the products
