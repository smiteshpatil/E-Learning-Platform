...
public class CourseController {
	...
	public ResponseEntity<?> getCoursesByInstructorId(@PathVariable Long instructorId){
		System.out.println("In get courses" + instructorId);
	...
	public ResponseEntity<?> getCourseDetailsByInstructorAndCourseId(@PathVariable Long instructorId, @PathVariable Long courseId) {
